...
export class InvestigationDetailsComponent implements OnChanges {
  ...
  investigationGridData = [
    ...
    },
    {
      ...
      investigatedParty: 'Issuer',
      roleType: 'Custody and Settlement Member',
      regulatedParty: 'BoE Stockbrokers (Pty) Ltd',
      sponsor: '',
      investigationType: 'Additional listing - New listing - AltX',
      dateCreated: new Date('2025-08-14T15:20:00'),
      allocatedTo: '',
    ...
    {
      filingNumber: '25081131-C',
      investigatedParty: 'Sponsor',
      roleType: 'Designated Advisor',
      regulatedParty: 'ABSA Bank Ltd (Trading as ABSA Corporate and Merchant Bank)',
      sponsor: '',
      investigationType: 'Additional listing - Rights Offer',
      dateCreated: new Date('2025-08-14T15:20:00'),
      allocatedTo: '',
      stage: 'New Process',
      status: 'New',
